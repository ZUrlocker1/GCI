...
enum SoundKey: String, CaseIterable {
    ...
    case uiConfirm                 // zapThreeToneUp.caf        (kenney-digital)
...
extension SoundKey {
    ...
    var filename: String {
        ...
        case .uiConfirm:                   return "kenney-digital/zapThreeToneUp.caf"
    ...
    var defaultVolume: Float {
        ...
        // One sound per screen: the kalimba is How To Play's, this is Settings'
        // — the panel and every control on it. A digital blip against a plucked
        // note, and the quieter of the two, which matters because this is the
        // one that repeats a dozen times while somebody adjusts things.
        //
        ...
        // 0.04 puts its loudest 50ms level with the settings blip, so RESET and
        // RESTORE read as a different button rather than a louder one. Low
        // because the file is loud, not because the cue should be faint.
        case .uiConfirm:                               return 0.04
        default:                                    return 0.8
        }
    }
}

...
- **Near-equal moves are shown whole** — At the opening the eight pawn and both knights glow and the text says "MOVE A PAWN OR KNIGHT". Where one move is genuinely better, the usual shortlist of three stands.

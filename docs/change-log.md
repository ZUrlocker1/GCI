...
- **Wide ties are shown whole** — At the opening every pawn move scores identically — 31 apiece against 0 for the knights — so lighting three of them would be alphabetical order dressed up as a recommendation. When the top of the ranking is a wide tie, every tied piece glows, up to eight. When one move is genuinely better, the usual shortlist stands.
...
- **Control prompts** — Three beats without firing raises "PRESS SPACE TO FIRE!" under the hint. Ten seconds of firing without steering raises "USE ARROWS TO MOVE!". Each goes the instant the control is used. Both are independent of the Chess Hints switch — someone who turned hints off can still be the one who has not found the trigger.
